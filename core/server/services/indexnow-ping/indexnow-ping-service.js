...
exports.IndexNowPingService = void 0;
...
class IndexNowPingService {
    ...
    hasSeoRelevantChanges(model) {
        return constants_1.seoFields.some(field => model.get(field) !== model.previous(field));
    }
    /**
    ...
    async ping(post) {
        ...
        try {
            ...
            if (!url || url.endsWith('/404/')) {
                ...
                }, `${constants_1.INDEXNOW_LOG_KEY} Skipped ping - post has no resolvable URL`);
                return;
            }
            ...
            }, `${constants_1.INDEXNOW_LOG_KEY} Successfully pinged ${url}`);
        }
        catch (err) {
            ...
            this.logging.warn({
                ...
                err: error
            }, `${constants_1.INDEXNOW_LOG_KEY} ${error.message}`);
        }
    }
    /**
    ...
    #classifyError(statusCode, err) {
        if (statusCode === 429) {
            ...
            return {
                ...
                error: new errors_1.default.TooManyRequestsError({
                    err,
                    message: err.message,
                    context: (0, tpl_1.default)(constants_1.messages.requestFailedError, { service: 'IndexNow' }),
        ...
        if (statusCode === 422 || statusCode === 403) {
            return {
                ...
                error: new errors_1.default.ValidationError({
                    err,
        ...
        return {
            ...
            error: new errors_1.default.InternalServerError({
                err,
                message: err.message,
                context: (0, tpl_1.default)(constants_1.messages.requestFailedError, { service: 'IndexNow' }),
                help: (0, tpl_1.default)(constants_1.messages.requestFailedHelp, { url: 'https://ghost.org/docs/' })
...
exports.IndexNowPingService = IndexNowPingService;
