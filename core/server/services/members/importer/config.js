...
exports.resolveInlineThreshold = resolveInlineThreshold;
...
const shippedThreshold = Threshold.parse(require('../../../../shared/config/defaults.json').members.importer.inlineThreshold);
...
function resolveInlineThreshold(configured) {
