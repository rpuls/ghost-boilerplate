import { u as k, j as e } from "./index-BWRct4la.mjs";
import { i as N, B as a, m as w } from "./button-BOW1bLRE.mjs";
import { k as C, l as y, m as z, X as M, n as H, o as $, p as P, q as D, C as I } from "./dialog-ChCs58Pc.mjs";
/**
...
const S = [
  ...
  secondaryTitle: f = "Spread the word!",
  description: t = "",
  featureImageURL: i = "",
  postTitle: l = "",
  postExcerpt: n = "",
  ...
  return /* @__PURE__ */ e.jsxs(C, { ...v, children: [
    /* @__PURE__ */ e.jsx(y, { className: "cursor-pointer", asChild: !0, children: j }),
    /* @__PURE__ */ e.jsxs(z, { className: "max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", children: [
      ...
      /* @__PURE__ */ e.jsxs(H, { className: "relative -mt-5", children: [
        /* @__PURE__ */ e.jsxs($, { className: "text-3xl leading-[1.15em] font-bold", children: [
          /* @__PURE__ */ e.jsx("span", { className: "text-state-success", children: m }),
          /* @__PURE__ */ e.jsx("br", {}),
...
//# sourceMappingURL=post-share-modal-DfVCjWzg.mjs.map
