import { R as A, aj as B, am as j, p as N, ad as H, a9 as C, D as K, ae as P, ak as U } from "./index-Dqn5WIFh.js";
import { B as J } from "./button-CG2Dpjqy.js";
const gt = ({ isLoading: r, onClick: a }) => {
  const e = !!r;
...
function I(r, a, e) {
  ...
  function i() {
    const o = r();
    return (o.length !== s.length || o.some((h, c) => s[c] !== h)) && (s = o, t = a(...o), e?.onChange && !(n && e.skipInitialOnChange) && e.onChange(t), n = !1), t;
  }
...
const $ = (r, a) => Math.abs(r - a) < 1.01, X = (r, a, e) => {
  let s;
  return function(...t) {
    r.clearTimeout(s), s = r.setTimeout(() => a.apply(this, t), e);
  };
};
let w;
const L = () => {
  if (w !== void 0) return w;
  if (typeof navigator > "u") return w = !1;
  if (/iP(hone|od|ad)/.test(navigator.userAgent)) return w = !0;
  const r = navigator.maxTouchPoints;
  return w = navigator.platform === "MacIntel" && r !== void 0 && r > 0;
}, W = (r) => {
  const { offsetWidth: a, offsetHeight: e } = r;
  return { width: a, height: e };
}, Y = (r) => r, Z = (r) => {
  const a = Math.max(r.startIndex - r.overscan, 0), s = Math.min(r.endIndex + r.overscan, r.count - 1) - a + 1, t = new Array(s);
  for (let n = 0; n < s; n++)
    t[n] = a + n;
  return t;
}, G = (r, a) => {
  ...
  passive: !0
}, Q = typeof window > "u" ? !0 : "onscrollend" in window, tt = (r, a, e) => {
  ...
  if (!t)
    return;
  const n = r.options.useScrollendEvent && Q;
  let i = 0;
  const o = n ? null : X(
    t,
    () => a(i, !1),
  ...
  const { horizontal: s, isRtl: t } = r.options;
  return s ? e.scrollLeft * (t && -1 || 1) : e.scrollTop;
}), st = (r, a, e) => {
  if (a?.borderBoxSize) {
  ...
  (n = (t = s.scrollElement) == null ? void 0 : t.scrollTo) == null || n.call(t, {
    [s.options.horizontal ? "left" : "top"]: r + a,
    behavior: e
  });
}, it = nt;
class ot {
  constructor(a) {
    this.unsubs = [], this.scrollElement = null, this.targetWindow = null, this.isScrolling = !1, this.scrollState = null, this.measurementsCache = [], this._flatMeasurements = null, this.itemSizeCache = /* @__PURE__ */ new Map(), this.itemSizeCacheVersion = 0, this.laneAssignments = /* @__PURE__ */ new Map(), this.pendingMin = null, this.prevLanes = void 0, this.lanesChangedFlag = !1, this.lanesSettling = !1, this.scrollRect = null, this.scrollOffset = null, this.scrollDirection = null, this.scrollAdjustments = 0, this._iosDeferredAdjustment = 0, this._iosTouching = !1, this._iosJustTouchEnded = !1, this._iosTouchEndTimerId = null, this._intendedScrollOffset = null, this.elementsCache = /* @__PURE__ */ new Map(), this.now = () => {
      ...
      const s = () => e || (!this.targetWindow || !this.targetWindow.ResizeObserver ? null : e = new this.targetWindow.ResizeObserver((t) => {
        t.forEach((n) => {
          const i = () => {
            const o = n.target, l = this.indexFromElement(o);
            if (!o.isConnected) {
      ...
      if (this.scrollElement !== s) {
        ...
        if (this.scrollElement = s, this.scrollElement && "ownerDocument" in this.scrollElement ? this.targetWindow = this.scrollElement.ownerDocument.defaultView : this.targetWindow = ((e = this.scrollElement) == null ? void 0 : e.window) ?? null, this.elementsCache.forEach((t) => {
          ...
          this.options.observeElementOffset(this, (t, n) => {
            this._intendedScrollOffset !== null && Math.abs(t - this._intendedScrollOffset) < 1.5 && (t = this._intendedScrollOffset), this._intendedScrollOffset = null, this.scrollAdjustments = 0, this.scrollDirection = n ? this.getScrollOffset() < t ? "forward" : "backward" : null, this.scrollOffset = t, this.isScrolling = n, this._flushIosDeferredIfReady(), this.scrollState && this.scheduleScrollReconcile(), this.maybeNotify();
          })
        ), "addEventListener" in this.scrollElement) {
          const t = this.scrollElement, n = () => {
          ...
          t.addEventListener(
            ...
            t.removeEventListener("touchstart", n), t.removeEventListener("touchend", i), this._iosTouchEndTimerId !== null && this.targetWindow != null && (this.targetWindow.clearTimeout(this._iosTouchEndTimerId), this._iosTouchEndTimerId = null);
          });
        }
      ...
      const e = this.getScrollOffset(), s = this.getMaxScrollOffset();
      if (e < 0 || e > s) return;
      const t = this._iosDeferredAdjustment;
      ...
      for (let i = s - 1; i >= 0; i--) {
        ...
        if (l == null || o.end > l.end ? n.set(o.lane, o) : o.end < l.end && t.set(o.lane, !0), t.size === this.options.lanes)
          break;
      }
      ...
      (e, s, t, n, i, o, l) => (this.prevLanes !== void 0 && this.prevLanes !== o && (this.lanesChangedFlag = !0), this.prevLanes = o, this.pendingMin = null, {
        count: e,
        paddingStart: s,
        scrollMargin: t,
        getItemKey: n,
      ...
      ({
        ...
        if (this.pendingMin = null, this.lanesSettling && this.measurementsCache.length === e && (this.lanesSettling = !1), o === 1) {
          const u = this.options.gap, S = e * 2;
          ...
          for (let g = f; g < e; g++) {
            const _ = n(g), M = c.get(_), y = typeof M == "number" ? M : this.options.estimateSize(g);
            m[g * 2] = p, m[g * 2 + 1] = y, p += y + u;
          }
          const v = q(e, m, n);
          return this.measurementsCache = v, v;
        }
        const d = this.measurementsCache.slice(0, f), E = new Array(o).fill(
          void 0
        );
        for (let u = 0; u < f; u++) {
          const S = d[u];
        ...
        for (let u = f; u < e; u++) {
          ...
          if (m !== void 0 && this.options.lanes > 1) {
            ...
            v = T ? T.end + this.options.gap : s + t;
          } else {
            const b = this.options.lanes === 1 ? d[u - 1] : this.getFurthestMeasurement(d, u);
            v = b ? b.end + this.options.gap : s + t, p = b ? b.lane : u % this.options.lanes, this.options.lanes > 1 && g && this.laneAssignments.set(u, p);
          }
          const _ = c.get(S), M = typeof _ == "number" ? _ : this.options.estimateSize(u), y = v + M;
          d[u] = {
            index: u,
            start: v,
            size: M,
      ...
      (e, s, t, n) => this.range = e.length > 0 && s > 0 ? rt({
        measurements: e,
        outerSize: s,
        scrollOffset: t,
        lanes: n,
      ...
      const s = this.indexFromElement(e), t = this.options.getItemKey(s), n = this.elementsCache.get(t);
      n !== e && (n && this.observer.unobserve(n), this.observer.observe(e), this.elementsCache.set(t, e)), (!this.isScrolling || this.scrollState) && this.shouldMeasureDuringScroll(s) && this.resizeItem(s, this.options.measureElement(e, void 0, this));
    }, this.resizeItem = (e, s) => {
      var t;
      ...
      if (this.options.lanes === 1 && l !== null)
        o = this.options.getItemKey(e), i = l[e * 2], n = l[e * 2 + 1];
      else {
        const f = this.measurementsCache[e];
        if (!f) return;
        o = f.key, i = f.start, n = f.size;
      }
      const h = this.itemSizeCache.get(o) ?? n, c = s - h;
      c !== 0 && (((t = this.scrollState) == null ? void 0 : t.behavior) !== "smooth" && (this.shouldAdjustScrollPositionOnItemSizeChange !== void 0 ? this.shouldAdjustScrollPositionOnItemSizeChange(
        ...
        behavior: void 0
      })), (this.pendingMin === null || e < this.pendingMin) && (this.pendingMin = e), this.itemSizeCache.set(o, s), this.itemSizeCacheVersion++, this.notify(!1));
      ...
      if (s.length === 0)
        return;
      const t = this._flatMeasurements, n = this.options.lanes === 1 && t != null, i = D(
        0,
        s.length - 1,
        n ? (o) => t[o * 2] : (o) => R(s[o]).start,
        e
      );
      return R(s[i]);
      ...
      if (!i) return;
      if (s === "auto")
        if (i.end >= n + t - this.options.scrollPaddingEnd)
          s = "end";
      ...
      return [
        this.getOffsetForAlignment(o, s, i.size),
        s
      ];
      ...
      this.scrollState = {
        ...
        lastTargetOffset: i,
        stableFrames: 0
      }, this._scrollToOffset(i, { adjustments: void 0, behavior: t }), this.scheduleScrollReconcile();
      ...
      if (s.length === 0)
        ...
        i != null ? t = i[n * 2] + i[n * 2 + 1] : t = ((e = s[n]) == null ? void 0 : e.end) ?? 0;
      } else {
      ...
      const s = this.getMeasurements();
      for (const t of s)
        t && this.itemSizeCache.has(t.key) && e.push({
          index: t.index,
          key: t.key,
          start: t.start,
          size: t.size,
      ...
      this._intendedScrollOffset = e + (s ?? 0), this.options.scrollToFn(e, { behavior: t, adjustments: s }, this);
    }, this.measure = () => {
  ...
  reconcileScroll() {
    ...
    if (!i && $(t, this.getScrollOffset())) {
      ...
      const o = this.getSize() || 600, l = Math.abs(t - this.getScrollOffset()), h = this.scrollState.behavior === "smooth" && l > o;
      this.scrollState.lastTargetOffset = t, h || (this.scrollState.behavior = "auto"), this._scrollToOffset(t, {
        adjustments: void 0,
...
function rt({
  ...
  const n = r.length - 1, i = t ? (c) => t[c * 2] : (c) => r[c].start, o = t ? (c) => t[c * 2] + t[c * 2 + 1] : (c) => r[c].end;
  if (r.length <= s)
    return {
      startIndex: 0,
      endIndex: n
  ...
  if (s === 1)
    ...
    for (; h < n && c.some((d) => d < e + a); ) {
      const d = r[h];
      c[d.lane] = d.end, h++;
    }
    const f = Array(s).fill(e + a);
    for (; l >= 0 && f.some((d) => d >= e); ) {
      const d = r[l];
      f[d.lane] = d.start, l--;
    }
...
const F = typeof document < "u" ? H : C;
function lt({
  useFlushSync: r = !0,
  ...a
}) {
  const e = B((n) => n + 1, 0)[1], s = {
    ...a,
    onChange: (n, i) => {
      var o;
      r && i ? N(e) : e(), (o = a.onChange) == null || o.call(a, n, i);
    }
  }, [t] = j(
    () => new ot(s)
  );
...
const V = 1e3, z = "ghostVirtualListWindow";
function ht({
  totalItems: r,
  unlockedItemCount: a
}) {
...
function k(r, a, e = V) {
  ...
  if (!s || typeof s != "object")
    return e;
  const t = s[a];
  return typeof t != "number" || !Number.isFinite(t) ? e : Math.max(1, Math.floor(t));
}
function dt(r, a, e) {
  if (typeof window > "u")
    return;
...
function St(r, {
  ...
  const { key: e, pathname: s, search: t } = P(), i = ut(s, a ?? t), [o, l] = j(() => k(x(), i)), h = U(i);
  C(() => {
    if (h.current !== i) {
      h.current = i, l(k(x(), i));
      return;
...
//# sourceMappingURL=virtual-list-window-CNahQBXY.js.map
