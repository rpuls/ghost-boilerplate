import { L as k, E as $, a as z } from "./index-DSX261S9.js";
import { bM as R, bP as t, v as Y, L as W, bk as Z, aD as x, aY as G, aX as _, bO as V, T as E, s as T } from "./index-DF6YEs01.js";
const U = 135, m = 1, q = 136, C = 137, P = 2, N = 138, F = 3, I = 4, X = [
  9,
  10,
  11,
  12,
...
const v = (e, r, i) => (O, a) => {
  ...
  if (X.includes(e.peek(-1))) {
    let { next: r } = e;
    (Q(r) || r == b || r == A || r == L || r == Oe || r == K || r == D && Q(e.peek(1)) || r == c || r == H) && e.acceptToken(U);
  }
}), oe = new $((e) => {
  if (!X.includes(e.peek(-1))) {
    let { next: r } = e;
...
function w(e, r, i) {
  if (r.to - r.from > 4096) {
    ...
    if (O)
      return O;
    let a = [], o = /* @__PURE__ */ new Set(), l = r.cursor(T.IncludeAnonymous);
    if (l.firstChild())
      do
...
//# sourceMappingURL=index-BpM6W2br.js.map
