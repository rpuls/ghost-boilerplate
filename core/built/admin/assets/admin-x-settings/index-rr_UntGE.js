import { V as st, S as Q, Q as v, ah as it, R as Ee, bM as Ie, am as H, bF as ot, bP as m, bO as X, j as P, aE as z, v as fe, X as at, by as lt, l as ht, t as ft, bl as ut, aZ as dt, aR as pt, g as ct, k as mt, aY as Me, bk as gt, bz as kt, u as ue, U as Lt } from "./index-DF6YEs01.js";
import { html as bt, htmlCompletionSource as wt } from "./index-CwEblQZC.js";
class j {
...
const je = { resolve: "Emphasis", mark: "EmphasisMark" }, _e = { resolve: "Emphasis", mark: "EmphasisMark" }, M = {}, _ = {};
class C {
  constructor(e, r, n, s) {
...
const G = {
  ...
  Emphasis(t, e, r) {
    ...
    return t.append(new C(e == 95 ? je : _e, r, n, (d ? 1 : 0) | (c ? 2 : 0)));
  },
  HardBreak(t, e, r) {
  ...
  resolveMarkers(e) {
    for (let n = e; n < this.parts.length; n++) {
      ...
      if (!(s instanceof C && s.type.resolve && s.side & 2))
        continue;
      let i = s.type == je || s.type == _e, o = s.to - s.from, a, l = n - 1;
      for (; l >= e; l--) {
        let g = this.parts[l];
...
}, Ye = /* @__PURE__ */ pt({ commentTokens: { block: { open: "<!--", close: "-->" } } }), Je = /* @__PURE__ */ new v(), We = /* @__PURE__ */ Nt.configure({
  props: [
...
function le(t) {
  return new ft(Ye, t, [], "markdown");
}
const Kt = /* @__PURE__ */ le(We), Yt = /* @__PURE__ */ We.configure([jt, qt, _t, Qt, {
  props: [
    /* @__PURE__ */ Me.add({
  ...
  let n = X(e), { doc: s } = e, i = null, o = e.changeByRange((a) => {
    ...
    if (p.item && d) {
      ...
      if (w.to >= l || S && S.to < l || h.from > 0 && !/[^\s>]/.test(s.lineAt(h.from - 1).text) || t.nonTightLists === !1) {
        ...
        return p.node.name == "OrderedList" && Y(p.item, s, y, -2), b && b.node.name == "OrderedList" && Y(b.item, s, y), { range: P.cursor(E + I.length), changes: y };
      } else {
        let b = Be(f, e, h);
        return {
    ...
    let c = [];
    p.node.name == "OrderedList" && Y(p.item, s, c);
...
//# sourceMappingURL=index-rr_UntGE.js.map
