import { V as M, R as L, S as $, D as E, Q as y, am as S, s as j } from "./index-DF6YEs01.js";
class v {
  /**
  @internal
  */
...
class q {
  constructor(t, e, s, i) {
    this.parser = t, this.input = e, this.ranges = i, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new U(e, i), this.tokens = new V(t, this.stream), this.topTerm = t.top[1];
    let { from: h } = i[0];
...
//# sourceMappingURL=index-DSX261S9.js.map
