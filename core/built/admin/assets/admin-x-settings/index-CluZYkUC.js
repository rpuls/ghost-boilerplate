import { L as W, E as i, C as B } from "./index-DSX261S9.js";
import { bM as U, bP as n, v as b, bF as E, L as C, bk as u, aS as v, aY as M, aX as N } from "./index-DF6YEs01.js";
const c = 63, D = 64, j = 1, A = 2, y = 3, F = 4, Z = 5, H = 6, I = 7, z = 65, K = 66, J = 8, OO = 9, eO = 10, aO = 11, rO = 12, V = 13, tO = 19, nO = 20, oO = 29, PO = 33, QO = 34, sO = 47, lO = 0, T = 1, g = 2, d = 3, m = 4;
class s {
  constructor(e, a, r) {
...
const fO = new i((O, e) => {
  ...
  if (O.next == 45)
    ...
    O.advance(), l(O.next) && O.acceptToken(e.context.type == g && e.context.depth == X(O, O.pos - 1) ? H : Z);
  else {
    let a = O.pos;
    for (; ; )
      if (x(O.next)) {
...
function q(O, e) {
  return O.next == 37 ? (O.advance(), Y(O.next) && O.advance(), Y(O.next) && O.advance(), !0) : dO(O.next) || e && O.next == 44 ? (O.advance(), !0) : !1;
}
function G(O) {
...
//# sourceMappingURL=index-CluZYkUC.js.map
